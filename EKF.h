...
static void EKF_init(const double nGyro, const double nAcc, const double nMag)
{
  int i;
...
void updateEKFQuatAtt(const double gyr_rps[3], const double acc_mps2[3], const
                      double mag_unit[3], double Va_mps, double magDecRad,
                      double T, double NdivT, double *roll_deg, double
                      *pitch_deg, double *yaw_deg)
{
  double mnorm;
  int i0;
  int iy;
